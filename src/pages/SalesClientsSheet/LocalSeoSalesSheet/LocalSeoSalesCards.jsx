...
const TicketCard = ({ heading, counter }) => {
  ...
  useEffect(() => {
    ...
    if (pathname === "/localseoactiveclients" && heading === "Active Clients") {
      setSelected(true);
    } else if (
      pathname === "/localseoInactiveclients" &&
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${apiUrl}/api/tickets?departmentId=${"65195c4b504d80e8f11b0d13"}&salesDep=true`
        );
  ...
  return (
    <>
      <div className="filterticketscard">
        ...
        <div className="col-6">
          <Link to="/localseoInactiveclients">
...
export default LocalSeoSalesCards;
