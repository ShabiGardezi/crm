...
const TicketCard = ({ heading, counter }) => {
  ...
  useEffect(() => {
    ...
    if (
      pathname === "/socialmedia_activeclients" &&
      heading === "Active Clients"
    ) {
      setSelected(true);
    } else if (
      pathname === "/socialmedia_Inactiveclients" &&
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${apiUrl}/api/tickets?departmentId=${"651ada78819ff0aec6af1381"}&salesDep=true`
        );
  ...
  return (
    <>
      <div className="filterticketscard">
        ...
        <div className="col-6">
          <Link to="/socialmedia_Inactiveclients">
...
export default SocialMediaSalesCards;
