...
const TicketCard = ({ heading, counter }) => {
  ...
  useEffect(() => {
    ...
    if (pathname === "/wordpressactiveclients" && heading === "Active Clients") {
      setSelected(true);
    } else if (
      pathname === "/wordpressInactiveclients" &&
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${apiUrl}/api/tickets?departmentId=${"65195c81504d80e8f11b0d14"}&salesDep=true`
        );
  ...
  return (
    <>
      <div className="filterticketscard">
        ...
        <div className="col-6">
          <Link to="/wordpressInactiveclients">
...
export default WordpressSalesCards;
