...
const TicketCard = ({ heading, counter }) => {
  ...
  useEffect(() => {
    ...
    if (pathname === "/marketingactiveclients" && heading === "Active Clients") {
      setSelected(true);
    } else if (
      pathname === "/marketingInactiveclients" &&
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${apiUrl}/api/tickets?departmentId=${"651ada3c819ff0aec6af1380"}&salesDep=true`
        );
  ...
  return (
    <>
      <div className="filterticketscard">
        ...
        <div className="col-6">
          <Link to="/marketingInactiveclients">
...
export default MarketingSalesCards;
